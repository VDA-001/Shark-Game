"""
Django settings for Shark_Game_Backend project.
...
SECRET_KEY = 'django-insecure-g+(c96pw=5iwyx$+uu4)mg^#u8m%9-x(3i-!p1gn65*2=vjr_x'
...
ROOT_URLCONF = 'Shark_Game_Backend.urls'
